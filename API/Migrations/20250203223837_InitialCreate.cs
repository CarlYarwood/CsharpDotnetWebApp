        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CareTeams_AspNetUsers_LeadId",
                        column: x => x.LeadId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CareTeamId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patients_CareTeams_CareTeamId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCareTeams", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserCareTeams_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserCareTeams_CareTeams_CareTeamId",
                        column: x => x.CareTeamId,
                        principalTable: "CareTeams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CareTeams_LeadId",
                table: "CareTeams",
                column: "LeadId");

            migrationBuilder.CreateIndex(
                name: "IX_Patients_CareTeamId",
                table: "Patients",
                column: "CareTeamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCareTeams_CareTeamId",
                table: "UserCareTeams",
                column: "CareTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCareTeams_UserId",
                table: "UserCareTeams",
                column: "UserId");
        }
